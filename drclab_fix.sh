...
# ==============================================================================
# DRCLAB Workstation Stability Automation Fix
# Target Hardware: Hybrid Intel CPU + Intel i915 iGPU + AMD Dedicated GPU Matrix
# Universally Compatible Family Selector
# ==============================================================================
...
echo -e "\e[33m[*] System will automatically force reboot in 5 seconds to clear desktop inhibitors...\e[0m"
echo -e "\e[33m[*] Press Ctrl+C right now if you want to cancel the reboot.\e[0m"

# 4. Five-second countdown loop before execution override
for i in {5..1}; do
    echo -ne "\r[*] Rebooting in $i... "
    sleep 1
done
echo -e "\n\e[34m[*] Executing forced system restart sequence...\e[0m"

# Force immediate reboot overriding GNOME session locks
systemctl reboot -i#!/usr/bin/env bash
